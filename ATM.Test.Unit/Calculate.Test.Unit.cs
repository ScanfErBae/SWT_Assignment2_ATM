...
namespace ATM.Test.Unit
{
    ...
    class CalculateTest
    {
        ...
        [TestCase(12500, 13000, 12500, 14000, 0)]
        [TestCase(12500, 13000, 14500, 10500, 141.34019174590992)]
        [TestCase(10000, 10000, 10050, 10005, 84.289406862500371)]
        [TestCase(10000, 10000, 10005, 10050, 5.7105931374996421)]
        [TestCase(10000, 10000, 10050, 10050, 45)]
        [TestCase(10000, 10000, 10000, 10050, 0)]
        [TestCase(20000, 20000, 19950, 20050, 315)]
        [TestCase(20000, 20000, 19950, 20000, 270)]
        [TestCase(20000, 20000, 19950, 19950, 225)]
        [TestCase(20000, 20000, 20000, 19950, 180)]
        [TestCase(20000, 20000, 20050, 19950, 135)]
        [TestCase(14642, 63625, 26252, 43315, 150.24600532958397)]
        ...
        [TestCase(20000, 20000, 2019, 10, 27, 15, 0, 0, 0, 30000, 30000, 2019, 10, 27, 15, 2, 0, 0, 117.85113019775793)]
        [TestCase(10000, 10000, 2019, 10, 27, 15, 0, 0, 0, 90000, 90000, 2019, 10, 27, 15, 5, 0, 0, 377.12361663282536)]
        [TestCase(10000, 10000, 2019, 10, 27, 15, 0, 0, 0, 90000, 90000, 2019, 10, 27, 16, 0, 0, 0, 31.426968052735447)]
        [TestCase(20000, 20000, 2019, 10, 27, 15, 0, 0, 0, 20500, 20500, 2019, 10, 27, 15, 1, 0, 0, 11.785113019775793)]// Min test
        [TestCase(20000, 20000, 2019, 10, 27, 15, 0, 0, 0, 20500, 20500, 2019, 10, 27, 15, 1, 1, 0, 11.591914445681107)]// Sec test
        [TestCase(20000, 20000, 2019, 10, 27, 15, 0, 0, 0, 20500, 20500, 2019, 10, 27, 15, 1, 0, 1, 11.784916604499051)]// Ms test
